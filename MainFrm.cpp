...
#include "MFCApplication2View.h" //1
#include "MyTreeView.h" // 3
...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CMFCApplication2View), CSize(0, 0), pContext);

	SetActiveView((CView*)m_wndSplitter.GetPane(0, 1));

	CMFCApplication2Doc* pDoc = (CMFCApplication2Doc*)GetActiveDocument();

	pDoc->m_pTreeView = (CMyTreeView*)m_wndSplitter.GetPane(0, 0);
	pDoc->m_pView = (CMFCApplication2View*)m_wndSplitter.GetPane(0, 1);
